...
| Attribute Name         | Type       | Required | Example Value                 | Description                       |
|---------------|------------|------|-----------------------|----------------------------|
| `requestUUID` | `String`   | 是   | `2137890`                   | Unique identifier for the request.     |
| `userId`      | `String`   | 是   | `1308764`        | 	Tenant ID.               |
| `createBy`    | `String`   | 是   | ``               | 	Information about the creator (no actual control effect).      |
| `message`     | `String`   | 是   | ``                   | 	Description message (no actual control effect).     |
| `apiKey`      | `String`   | 是   | ``        | apiKey                 |
| `errCode`     | `int`      | 是   | ``               | 	Error code: 0 indicates success; other values indicate failure.     |
| `data`        | `String`   | 是   | ``               | 	Encrypted data using an RSA public key.     |
...
| `trackingId`     | `String`   | 是   | `track-4567`          | Order tracking ID.             |
